!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : e(
          (((t =
            "undefined" != typeof globalThis ? globalThis : t || self).PIXI =
            t.PIXI || {}),
    ...
    a = (t, e, i) =>
      new Promise((s, r) => {
        var o = (t) => {
          ...
          n = (t) =>
            t.done ? s(t.value) : Promise.resolve(t.value).then(o, a);
  ...
  class c {
    ...
    doFade(t, e, i, s) {
      ...
      for (let n = i; n < i + s; ++n) {
        ...
        if (r == n) t.setPartOpacityByIndex(e, o);
        else {
          let i,
            s = t.getPartOpacityByIndex(e);
          i = o < a ? (-0.5 * o) / a + 1 : ((1 - o) * a) / 0.5;
    ...
    static cardanoAlgorithmForBezier(e, i, s, r) {
      ...
      if (d < 0) {
        const t = -n / 3,
          ...
          a = Math.acos(r),
          l = 2 * this.cbrt(i),
          u = l * this.cos(a / 3) - o / 3;
        if (this.abs(u - c) < g) return this.range(u, 0, 1);
        const d = l * this.cos((a + 2 * Math.PI) / 3) - o / 3;
        if (this.abs(d - c) < g) return this.range(d, 0, 1);
        const m = l * this.cos((a + 4 * Math.PI) / 3) - o / 3;
  ...
  let M,
    v = !1,
    P = !1;
  const b = { vertexOffset: 0, vertexStep: 2 };
  class S {
    static startUp(t) {
    ...
    static dispose() {
      v
        ? P
          ? (x.staticRelease(),
            (P = !1),
            E("CubismFramework.dispose() is complete."))
  ...
  class O {
    ...
    setPartColor(t, e, i, s, r, o, a) {
      if (
        ...
        for (let n = 0; n < this._partChildDrawables[t].length; ++n) {
          const o = this._partChildDrawables[t][n];
          (a[o].Color.R = e),
            (a[o].Color.G = i),
            (a[o].Color.B = s),
            (a[o].Color.A = r);
    ...
    initialize() {
      ...
      }
      {
        ...
        for (let t = 0; t < i; ++t) {
          const i = new y(1, 1, 1, 1),
            r = new y(0, 0, 0, 1),
            o = new D(!1, i),
            a = new D(!1, r);
          this._drawableIds.push(e[t]),
            this._userMultiplyColors.push(o),
            this._userScreenColors.push(a),
            this._userCullings.push(s);
          const n = this.getDrawableParentPartIndex(t);
          n >= 0 && this._partChildDrawables[n].push(t);
        }
      }
    }
    constructor(t) {
          ...
          e.Blend && "Add" !== e.Blend
            ? "Multiply" === e.Blend
              ...
              : "Overwrite" === e.Blend
                ...
                : 0
            : 0;
        const a = { parameterId: s, blendType: o, value: r };
  ...
  (t.CubismConfig = void 0),
    ((X = t.CubismConfig || (t.CubismConfig = {})).supportMoreMaskDivisions =
      !0),
    (X.setOpacityFromMotion = !1);
  var j = ((t) => (
  ...
  function st(t, e) {
    const i = e,
      ...
      h = 3 * o - 3 * s,
      u = s - i,
      d = _.cardanoAlgorithmForBezier(n, l, h, u),
      c = tt(t[0], t[1], d),
      g = tt(t[1], t[2], d),
      m = tt(t[2], t[3], d),
      p = tt(c, g, d),
  ...
  function at(t, e, i) {
    ...
    for (let l = s.baseSegmentIndex; l < o; ++l)
      if (
        ((a =
          ...
          (t.segments[l].segmentType == H.CubismMotionSegmentType_Bezier
            ? 3
            : 1)),
        t.points[a].time > i)
      ) {
    ...
    if (-1 == r) return t.points[a].value;
  ...
  class nt extends N {
    ...
    doUpdateParameters(e, i, s, r) {
      ...
      for (
        ...
        x[m].type == j.CubismMotionCurveTarget_Model;
        ++m
      )
        (g = at(this._motionData, m, f)),
          x[m].id == this._modelCurveIdEyeBlink
            ? (n = g)
            : x[m].id == this._modelCurveIdLipSync
              ? (a = g)
              : x[m].id == this._modelCurveIdOpacity &&
                ((this._modelOpacity = g),
                e.setModelOapcity(this.getModelOpacityValue()));
      for (
        ;
        m < this._motionData.curveCount &&
        x[m].type == j.CubismMotionCurveTarget_Parameter;
        ++m
      ) {
        if (((p = e.getParameterIndex(x[m].id)), -1 == p)) continue;
        const t = e.getParameterValueByIndex(p);
        if (((g = at(this._motionData, m, f)), n != Number.MAX_VALUE))
          for (let e = 0; e < this._eyeBlinkParameterIds.length && e < l; ++e)
            if (this._eyeBlinkParameterIds[e] == x[m].id) {
              (g *= n), (u |= 1 << e);
              break;
            }
        if (a != Number.MAX_VALUE)
          for (let e = 0; e < this._lipSyncParameterIds.length && e < l; ++e)
            if (this._lipSyncParameterIds[e] == x[m].id) {
              (g += a), (h |= 1 << e);
              break;
            }
        let o;
        if (x[m].fadeInTime < 0 && x[m].fadeOutTime < 0) o = t + (g - t) * s;
        else {
          let e, s;
          (e =
            x[m].fadeInTime < 0
              ...
              : 0 == x[m].fadeInTime
                ? 1
                : _.getEasingSine(
                    (i - r.getFadeInStartTime()) / x[m].fadeInTime
                  )),
            (s =
              x[m].fadeOutTime < 0
                ? c
                : 0 == x[m].fadeOutTime || r.getEndTime() < 0
                  ? 1
                  : _.getEasingSine((r.getEndTime() - i) / x[m].fadeOutTime));
      ...
      for (
        ;
        m < this._motionData.curveCount &&
        x[m].type == j.CubismMotionCurveTarget_PartOpacity;
        ++m
      )
        if (
          ((g = at(this._motionData, m, f)),
    ...
    parse(t) {
      ...
      const i = e.getEvaluationOptionFlag(
          Q.EvaluationOptionFlag_AreBeziersRistricted
        ),
      ...
      for (let n = 0; n < this._motionData.curveCount; ++n) {
        ...
        switch (e.getMotionCurveTarget(n)) {
          case "Model":
            t.type = j.CubismMotionCurveTarget_Model;
            break;
          case "Parameter":
            t.type = j.CubismMotionCurveTarget_Parameter;
            break;
          case "PartOpacity":
            t.type = j.CubismMotionCurveTarget_PartOpacity;
            break;
          default:
            L(
        ...
        (t.id = e.getMotionCurveId(n)), (t.baseSegmentIndex = a);
        ...
        for (let l = 0; l < e.getMotionCurveSegmentCount(n); ) {
          0 == l
            ? ((this._motionData.segments[a].basePointIndex = o),
              ...
              (o += 1),
              (l += 2))
            : (this._motionData.segments[a].basePointIndex = o - 1);
          switch (e.getMotionCurveSegment(n, l)) {
            case H.CubismMotionSegmentType_Linear:
              (this._motionData.segments[a].segmentType =
                H.CubismMotionSegmentType_Linear),
                (this._motionData.segments[a].evaluate = et),
                (this._motionData.points[o] = new W(
                  e.getMotionCurveSegment(n, l + 1),
            ...
            case H.CubismMotionSegmentType_Bezier:
              (this._motionData.segments[a].segmentType =
                ...
                (this._motionData.segments[a].evaluate = i ? it : st),
                (this._motionData.points[o] = new W(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
            ...
            case H.CubismMotionSegmentType_Stepped:
              (this._motionData.segments[a].segmentType =
                ...
                (this._motionData.segments[a].evaluate = rt),
                (this._motionData.points[o] = new W(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
            ...
            case H.CubismMotionSegmentType_InverseStepped:
              (this._motionData.segments[a].segmentType =
                ...
                (this._motionData.segments[a].evaluate = ot),
                (this._motionData.points[o] = new W(
                  e.getMotionCurveSegment(n, l + 1),
                  e.getMotionCurveSegment(n, l + 2)
                )),
    ...
    isExistModelOpacity() {
      for (let t = 0; t < this._motionData.curveCount; t++) {
        ...
        if (e.type == j.CubismMotionCurveTarget_Model && e.id === K) return !0;
      }
      return !1;
    }
    getModelOpacityIndex() {
      if (this.isExistModelOpacity())
        for (let t = 0; t < this._motionData.curveCount; t++) {
          const e = this._motionData.curves[t];
          if (e.type == j.CubismMotionCurveTarget_Model && e.id === K) return t;
        }
      return -1;
    }
    getModelOpacityId(t) {
      if (-1 != t) {
        const e = this._motionData.curves[t];
        if (e.type == j.CubismMotionCurveTarget_Model && e.id === K)
          return e.id;
      }
    }
    getModelOpacityValue() {
    ...
    doUpdateMotion(t, e) {
      ...
      for (; s < this._motions.length; ) {
        ...
        for (let t = 0; t < a.length; ++t)
          this._eventCallBack(this, a[t], this._eventCustomData);
  ...
  class yt {
    ...
    parse(t) {
      ...
      for (let o = 0; o < this._physicsRig.subRigCount; ++o) {
        ...
        this._currentRigOutputs.push(a),
          this._previousRigOutputs.push(n),
          (s += t.outputCount),
    ...
    stabilization(t) {
      ...
      for (let m = 0; m < t.getParameterCount(); ++m)
        (this._parameterCaches[m] = p[m]),
          (this._parameterInputCaches[m] = p[m]);
      for (let y = 0; y < this._physicsRig.subRigCount; ++y) {
        (o = { angle: 0 }),
          (h.x = 0),
          (h.y = 0),
          (u = this._physicsRig.settings[y]),
        ...
        for (let e = 0; e < u.inputCount; ++e)
          (a = d[e].weight / 100),
            ...
            (this._parameterCaches[d[e].sourceParameterIndex] =
              p[d[e].sourceParameterIndex]);
        (n = _.degreesToRadian(-o.angle)),
          (h.x = h.x * _.cos(n) - h.y * _.sin(n)),
          (h.y = h.x * _.sin(n) + h.y * _.cos(n)),
          Bt(
            g,
            u.particleCount,
            h,
        ...
        for (let e = 0; e < u.outputCount; ++e) {
          ...
          (s = g[i].position.substract(g[i - 1].position)),
            ...
            (this._currentRigOutputs[y].outputs[e] = l),
            (this._previousRigOutputs[y].outputs[e] = l);
      ...
      for (
        ...
        for (let i = 0; i < t.getParameterCount(); ++i)
          (this._parameterCaches[i] =
            this._parameterInputCaches[i] * (1 - e) + f[i] * e),
    ...
    interpolate(t, e) {
      ...
      (r = t.getModel().parameters.values),
        ...
        (a = t.getModel().parameters.minimumValues);
      for (let n = 0; n < this._physicsRig.subRigCount; ++n) {
        (s = this._physicsRig.settings[n]),
        ...
        for (let t = 0; t < s.outputCount; ++t) {
          ...
          Rt(
            ...
            a[s],
            o[s],
            this._previousRigOutputs[n].outputs[t] * (1 - e) +
              this._currentRigOutputs[n].outputs[t] * e,
            i[t]
          );
  ...
  function Pt(t, e, i, s, r, o, a, n, l, h) {
    t.x += Ot(i, s, r, o, a.minimum, a.maximum, a.defalut, l) * h;
  }
  function bt(t, e, i, s, r, o, a, n, l, h) {
    t.y += Ot(i, s, r, o, a.minimum, a.maximum, a.defalut, l) * h;
  }
  function St(t, e, i, s, r, o, a, n, l, h) {
    e.angle += Ot(i, s, r, o, n.minimum, n.maximum, n.defalut, l) * h;
  }
  ...
  function Dt(t, e, i, s, r, o, a, n) {
    ...
    (t[0].position = new m(i.x, i.y)),
      ...
      d.normalize();
    for (let x = 1; x < e; ++x)
      (t[x].force = d.multiplyByScaler(t[x].acceleration).add(r)),
        (t[x].lastPosition = new m(t[x].position.x, t[x].position.y)),
        (h = t[x].delay * a * 30),
        (c = t[x].position.substract(t[x - 1].position)),
        (u = _.directionToRadian(t[x].lastGravity, d) / n),
        (c.x = _.cos(u) * c.x - c.y * _.sin(u)),
        (c.y = _.sin(u) * c.x + c.y * _.cos(u)),
        (t[x].position = t[x - 1].position.add(c)),
        (g = t[x].velocity.multiplyByScaler(h)),
        (p = t[x].force.multiplyByScaler(h).multiplyByScaler(h)),
        (t[x].position = t[x].position.add(g).add(p)),
        (f = t[x].position.substract(t[x - 1].position)),
        f.normalize(),
        (t[x].position = t[x - 1].position.add(
          f.multiplyByScaler(t[x].radius)
        )),
        _.abs(t[x].position.x) < o && (t[x].position.x = 0),
        0 != h &&
          ((t[x].velocity = t[x].position.substract(t[x].lastPosition)),
          (t[x].velocity = t[x].velocity.divisionByScalar(h)),
          (t[x].velocity = t[x].velocity.multiplyByScaler(t[x].mobility))),
        (t[x].force = new m(0, 0)),
        (t[x].lastGravity = new m(d.x, d.y));
  }
  function Bt(t, e, i, s, r, o) {
    let a,
      ...
      l = new m(0, 0);
    (t[0].position = new m(i.x, i.y)),
      (a = _.degreesToRadian(s)),
      (n = _.radianToDirection(a)),
      n.normalize();
    for (let h = 1; h < e; ++h)
      (t[h].force = n.multiplyByScaler(t[h].acceleration).add(r)),
  ...
  class Gt {
    ...
    calcClippedDrawTotalBounds(t, e) {
      let i = Number.MAX_VALUE,
        ...
        r = Number.MIN_VALUE,
        o = Number.MIN_VALUE;
      const a = e._clippedDrawableIndexList.length;
      for (let n = 0; n < a; n++) {
        const a = e._clippedDrawableIndexList[n],
          l = t.getDrawableVertexCount(a),
          h = t.getDrawableVertices(a);
        let u = Number.MAX_VALUE,
          d = Number.MAX_VALUE,
          c = -Number.MAX_VALUE,
          g = -Number.MAX_VALUE;
        const m = l * b.vertexStep;
        for (let t = b.vertexOffset; t < m; t += b.vertexStep) {
          const e = h[t],
            i = h[t + 1];
          e < u && (u = e),
            e > c && (c = e),
        ...
        if (u != Number.MAX_VALUE)
          if (
            ...
            (e._allClippedDrawRect.x = i),
              ...
              (e._allClippedDrawRect.height = a);
          }
      }
    }
    constructor() {
          ...
          if (
            ...
            this._tmpBoundsOnModel.setRect(r),
              this._tmpBoundsOnModel.width * e > h
                ? (this._tmpBoundsOnModel.expand(r.width * a, 0),
                  (n = o.width / this._tmpBoundsOnModel.width))
                : (n = e / h),
              this._tmpBoundsOnModel.height * e > u
                ? (this._tmpBoundsOnModel.expand(0, r.height * a),
                  (l = o.height / this._tmpBoundsOnModel.height))
                : (l = e / u);
          } else
            this._tmpBoundsOnModel.setRect(r),
              this._tmpBoundsOnModel.expand(r.width * a, r.height * a),
              (n = o.width / this._tmpBoundsOnModel.width),
              (l = o.height / this._tmpBoundsOnModel.height);
          if (
  ...
  class Ht {
    ...
    setupShaderProgram(t, e, i, s, r, o, a, n, l, h, u, d, c, g, m) {
      let p, _, f, x;
      ...
      if (null != y) {
        ...
        let n;
        switch (l) {
          case C.CubismBlendMode_Normal:
          default:
            (n = this._shaderSets[1 + r]),
              (p = this.gl.ONE),
              (_ = this.gl.ONE_MINUS_SRC_ALPHA),
              (f = this.gl.ONE),
              (x = this.gl.ONE_MINUS_SRC_ALPHA);
            break;
          case C.CubismBlendMode_Additive:
            (n = this._shaderSets[4 + r]),
              (p = this.gl.ONE),
              (_ = this.gl.ONE),
              (f = this.gl.ZERO),
              (x = this.gl.ONE);
            break;
          case C.CubismBlendMode_Multiplicative:
            (n = this._shaderSets[7 + r]),
              (p = this.gl.DST_COLOR),
              (_ = this.gl.ONE_MINUS_SRC_ALPHA),
              (f = this.gl.ZERO),
              (x = this.gl.ONE);
        ...
        if (
          ...
          this.gl.uniform4f(n.uniformChannelFlagLocation, r.R, r.G, r.B, r.A);
        }
        this.gl.activeTexture(this.gl.TEXTURE0),
          this.gl.bindTexture(this.gl.TEXTURE_2D, e),
          this.gl.uniform1i(n.samplerTexture0Location, 0),
          this.gl.uniformMatrix4fv(n.uniformMatrixLocation, !1, g.getArray()),
          this.gl.uniform4f(n.uniformBaseColorLocation, h.R, h.G, h.B, h.A),
          this.gl.uniform4f(n.uniformMultiplyColorLocation, u.R, u.G, u.B, u.A),
          this.gl.uniform4f(n.uniformScreenColorLocation, d.R, d.G, d.B, d.A);
      }
  ...
  class te extends x {
    ...
    drawMesh(t, e, i, s, r, o, a, n, l, h, u) {
      this.isCulling()
  ...
  class Ce {
    ...
    update(t) {
      ...
      let a = o * (e / s) - this.vx,
        n = o * (i / s) - this.vy;
      const l = Math.sqrt(r(a, 2) + r(n, 2)),
        h = o * xe * t;
      l > h && ((a *= h / l), (n *= h / l)), (this.vx += a), (this.vy += n);
  ...
  class ve {
    ...
    reserve(t, e, i) {
      if (i <= 0)
        return (
          de.log(this.tag, "Cannot start a motion with MotionPriority.NONE."),
          !1
        );
      if (t === this.currentGroup && e === this.currentIndex)
        return (
          de.log(this.tag, "Motion is already playing.", this.dump(t, e)), !1
        );
      if (
        ...
        return (
          de.log(this.tag, "Motion is already reserved.", this.dump(t, e)), !1
        );
      if (1 === i) {
  ...
  class be {
    ...
    static dispose(t) {
      t.pause(), t.removeAttribute("src"), pe(this.audios, t);
    }
    static destroy() {
  ...
  o(be, "audios", []),
    ...
    o(be, "contexts", []),
    o(be, "_volume", Pe);
  var Se = ((t) => ((t.ALL = "ALL"), (t.IDLE = "IDLE"), (t.NONE = "NONE"), t))(
    Se || {}
  );
  class we extends e.utils.EventEmitter {
    constructor(t, e) {
      super(),
        o(this, "tag"),
        o(this, "settings"),
    ...
    speak(t) {
      return a(
        ...
        function* (
          ...
          if (c)
            try {
              (n = be.add(
                ...
                (this.currentAudio = n),
                (be.volume = e),
                (h = be.addContext(this.currentAudio)),
                (this.currentContext = h),
                (l = be.addAnalyzer(this.currentAudio, this.currentContext)),
          ...
          if (n) {
            let t = !0;
            const e = be.play(n).catch((e) => {
              de.warn(this.tag, "Failed to play audio", n.src, e), (t = !1);
            });
    ...
    startMotion(t, e) {
      return a(
        ...
        function* (
          ...
          if (this.currentAudio && !this.currentAudio.ended && i != Me.FORCE)
            return !1;
          const d = null == (u = this.definitions[t]) ? void 0 : u[e];
          if (!d) return !1;
          let c, g, m, p;
          this.currentAudio && be.dispose(this.currentAudio);
          const _ = s && s.startsWith("data:");
          if (s && !_) {
            const t = document.createElement("a");
            (t.href = s), (p = s = t.href);
          } else
            (p = this.getSoundFile(d)), p && (p = this.settings.resolveURL(p));
          const f = p;
          if (f)
            try {
              (c = be.add(
                ...
                (this.currentAudio = c),
                (be.volume = r),
                (m = be.addContext(this.currentAudio)),
                (this.currentContext = m),
                (g = be.addAnalyzer(this.currentAudio, this.currentContext)),
                (this.currentAnalyzer = g);
            } catch (C) {
              de.warn(this.tag, "Failed to create audio", p, C);
            }
          const x = yield this.loadMotion(t, e);
          if (c) {
            const t = be
              .play(c)
              .catch((t) =>
          ...
          return this.state.start(x, t, e, i)
            ? (this.state.shouldOverrideExpression() &&
                this.expressionManager &&
                this.expressionManager.resetExpression(),
              ...
              this._startMotion(x),
              !0)
            : (c && (be.dispose(c), (this.currentAudio = void 0)), !1);
        }
      );
    }
    ...
    stopSpeaking() {
      this.currentAudio &&
        (be.dispose(this.currentAudio), (this.currentAudio = void 0));
    }
    stopAllMotions() {
    ...
    mouthSync() {
      return this.currentAnalyzer ? be.analyze(this.currentAnalyzer) : 0;
    }
    destroy() {
      var t;
      (this.destroyed = !0),
  ...
  const Te = { x: 0, y: 0, width: 0, height: 0 };
  class Ie extends e.utils.EventEmitter {
    constructor() {
      super(...arguments),
        o(this, "focusController", new Ce()),
        o(this, "pose"),
        o(this, "physics"),
  ...
  const Le = class t {
    static createXHR(e, i, s, r, o) {
      ...
      if ((t.allXhrSet.add(a), e)) {
        let i = t.xhrMap.get(e);
        i ? i.add(a) : ((i = new Set([a])), t.xhrMap.set(e, i)),
      ...
      return (
        ...
        (a.onerror = () => {
          de.warn(
            "XHRLoader",
            `Failed to load resource as ${a.responseType} (Status ${a.status}): ${i}`
          ),
            o(new Ee("Network error.", i, a.status));
        }),
        (a.onabort = () => o(new Ee("Aborted.", i, a.status, !0))),
        (a.onloadend = () => {
          var i;
          t.allXhrSet.delete(a),
            e && (null == (i = t.xhrMap.get(e)) || i.delete(a));
        }),
        a
      );
    }
  ...
  o(Le, "xhrMap", new WeakMap()),
    o(Le, "allXhrSet", new Set()),
    o(
      Le,
      "loader",
      (t, e) =>
  ...
  function Ae(t, e) {
    ...
    return (function s(r, o) {
      ...
      try {
        return Promise.resolve(a(e, s.bind(null, r + 1)));
      } catch (n) {
  ...
  class De {
    static load(t) {
      return Ae(this.middlewares, t).then(() => t.result);
    }
  }
  function Be() {}
  o(De, "middlewares", [Fe.loader]);
  const Re = "Live2DFactory",
    Oe = (t, e) =>
      a(this, null, function* () {
        if ("string" == typeof t.source) {
          const e = yield De.load({
            url: t.source,
            type: "json",
    ...
    ke = (t, e) =>
      a(this, null, function* () {
        if (t.source instanceof ye) return (t.settings = t.source), e();
        if ("object" == typeof t.source) {
          const i = Ye.findRuntime(t.source);
          if (i) {
    ...
    Ue = (t, e) => {
      if (t.settings) {
        const i = Ye.findRuntime(t.settings);
      ...
      a(this, null, function* () {
        ...
        if (i) {
          ...
          if (s) {
            ...
            e.pose &&
              r.push(
                De.load({ settings: e, url: e.pose, type: "json", target: i })
                  .then((e) => {
                  ...
                  .catch((e) => {
                    t.live2dModel.emit("poseLoadError", e),
                      de.warn(Re, "Failed to load pose.", e);
                  })
              ),
              e.physics &&
                r.push(
                  De.load({
                    ...
                    .catch((e) => {
                      t.live2dModel.emit("physicsLoadError", e),
                        de.warn(Re, "Failed to load physics.", e);
                    })
                ),
    ...
    Ne = (t, i) =>
      a(this, null, function* () {
        if (!t.settings) throw new TypeError("Missing settings.");
        {
          ...
          if ((r.catch(Be), yield i(), !t.internalModel))
  ...
  o(Xe, "live2dFactory"),
    ...
    o(Xe, "factory", (t, e) =>
      a(Xe, null, function* () {
        ...
        if (
          ("string" == typeof i &&
          (i.endsWith(".zip") || i.startsWith(Xe.ZIP_PROTOCOL))
            ? ((s = i.startsWith(Xe.ZIP_PROTOCOL)
                ? i.slice(Xe.ZIP_PROTOCOL.length)
                : i),
              (r = yield De.load({
                url: s,
                type: "blob",
          ...
          const e = yield Xe.zipReader(r, s);
          o || (o = yield Xe.createSettings(e)),
            (o._objectURL = Xe.ZIP_PROTOCOL + Xe.uid + "/" + o.url);
          const i = yield Xe.unzip(e, o);
          (i.settings = o),
            (t.source = i),
            s.startsWith("blob:") &&
  ...
  const je = class t {
      ...
      return a(this, null, function* () {
        ...
        for (const t of s.getDefinedFiles()) {
          const o = decodeURI(e.utils.url.resolve(s.url, t)),
            a = i.find((t) => t.webkitRelativePath === o);
          a && (r[t] = URL.createObjectURL(a));
        }
    ...
    static createSettings(e) {
      return a(this, null, function* () {
        ...
        const o = Ye.findRuntime(r);
        if (!o) throw new Error("Unknown settings JSON");
        const a = o.createModelSettings(r);
        return (a._objectURL = URL.createObjectURL(i)), a;
      });
    }
    static readText(t) {
      return a(this, null, function* () {
    ...
    o(je, "factory", (t, e) =>
      a(je, null, function* () {
        if (Array.isArray(t.source) && t.source[0] instanceof File) {
          ...
          } else i = yield je.createSettings(e);
          i.validateFiles(e.map((t) => encodeURI(t.webkitRelativePath))),
            yield je.upload(e, i),
            (i.resolveURL = function (t) {
              return je.resolveURL(this._objectURL, t);
            }),
            (t.source = i),
            t.live2dModel.once("modelLoaded", (t) => {
              t.once("destroy", function () {
                const t = this.settings._objectURL;
                if ((URL.revokeObjectURL(t), je.filesMap[t]))
                  for (const e of Object.values(je.filesMap[t]))
                    URL.revokeObjectURL(e);
                delete je.filesMap[t];
              });
            });
        }
        return e();
  ...
  const We = class t {
    ...
    static setupLive2DModel(e, i, s) {
      return a(this, null, function* () {
        const r = new Promise((t) => e.once("textureLoaded", t)),
          ...
          a = Promise.all([r, o]).then(() => e.emit("ready"));
        yield Ae(t.live2DModelMiddlewares, {
          live2dModel: e,
          source: i,
          options: s || {},
        }),
    ...
    static loadMotion(e, i, s) {
      ...
      try {
        const a = null == (r = e.definitions[i]) ? void 0 : r[s];
        if (!a) return Promise.resolve(void 0);
        e.listeners("destroy").includes(t.releaseTasks) ||
          e.once("destroy", t.releaseTasks);
        let n = t.motionTasksMap.get(e);
        n || ((n = {}), t.motionTasksMap.set(e, n));
        let l = n[i];
        l || ((l = []), (n[i] = l));
        const h = e.getMotionFile(a);
        return (
          null != l[s] ||
            (l[s] = De.load({
              url: h,
              ...
              .then((r) => {
                var o;
                const n = null == (o = t.motionTasksMap.get(e)) ? void 0 : o[i];
                n && delete n[s];
                const l = e.createMotion(r, i, a);
          ...
          null != o[i] ||
            (o[i] = De.load({
              ...
              .then((s) => {
                ...
                o && delete o[i];
                const a = e.createExpression(s, r);
                return e.emit("expressionLoaded", i, a), a;
              })
              .catch((t) => {
                de.warn(e.tag, `Failed to load expression: ${a}\n`, t), s(t);
              })),
          o[i]
        );
      } catch (r) {
  ...
  o(We, "runtimes", []),
    o(We, "urlToJSON", Oe),
    o(We, "jsonToSettings", ke),
    o(We, "waitUntilReady", Ue),
    o(We, "setupOptionals", Ve),
    o(We, "setupEssentials", Ne),
    o(We, "createInternalModel", Ge),
    o(We, "live2DModelMiddlewares", [
      ze.factory,
      He.factory,
      Oe,
      ke,
    ...
    o(We, "motionTasksMap", new WeakMap()),
    o(We, "expressionTasksMap", new WeakMap());
  let Ye = We;
  (we.prototype._loadMotion = function (t, e) {
    return Ye.loadMotion(this, t, e);
  }),
    (_e.prototype._loadExpression = function (t) {
      return Ye.loadExpression(this, t);
    }),
    (He.live2dFactory = Ye),
    (ze.live2dFactory = Ye);
  const qe = class t {
    constructor(
      ...
      o(this, "model"),
        ...
        n ||
          (t.defaultTicker
            ? (n = t.defaultTicker)
            : "undefined" != typeof PIXI && (n = PIXI.Ticker.shared)),
        void 0 !== a &&
          ((s = a),
          (r = a),
          de.warn(
    ...
    set ticker(t) {
      var e;
      this._ticker && this._ticker.remove(Je, this),
        (this._ticker = t),
        this._autoUpdate && (null == (e = this._ticker) || e.add(Je, this));
    }
    get autoUpdate() {
    ...
    set autoUpdate(t) {
      ...
      this.destroyed ||
        (t
          ? this._ticker
            ? (this._ticker.add(Je, this), (this._autoUpdate = !0))
            : de.warn(
                this.model.tag,
          ...
          : (null == (e = this._ticker) || e.remove(Je, this),
            (this._autoUpdate = !1)));
    }
    get autoHitTest() {
    ...
    set autoHitTest(t) {
      t !== this.autoHitTest &&
        (t
          ? this.model.on("pointertap", Ze, this)
          : this.model.off("pointertap", Ze, this),
        (this._autoHitTest = t));
    }
    get autoFocus() {
    ...
    set autoFocus(t) {
      t !== this.autoFocus &&
        (t
          ? this.model.on("globalpointermove", Qe, this)
          : this.model.off("globalpointermove", Qe, this),
        (this._autoFocus = t));
    }
    get autoInteract() {
  ...
  class Ke extends e.Transform {}
  const ti = new e.Point(),
    ei = new e.Matrix();
  class ii extends i.Container {
    constructor(t) {
      super(),
        o(this, "tag", "Live2DModel(uninitialized)"),
        o(this, "internalModel"),
        o(this, "textures", []),
        o(this, "transform", new Ke()),
        o(
          this,
          "anchor",
        ...
        o(this, "deltaTime", 0),
        o(this, "automator"),
        (this.automator = new $e(this, t)),
        this.once("modelLoaded", () => this.init(t));
    }
    static from(t, e) {
      const i = new this(e);
      return Ye.setupLive2DModel(i, t, e).then(() => i);
    }
    static fromSync(t, e) {
      const i = new this(e);
      return (
        Ye.setupLive2DModel(i, t, e)
    ...
    focus(t, e, i = !1) {
      (ti.x = t), (ti.y = e), this.toModelPosition(ti, ti, !0);
      const s = (ti.x / this.internalModel.originalWidth) * 2 - 1,
        r = (ti.y / this.internalModel.originalHeight) * 2 - 1,
        o = Math.atan2(r, s);
    ...
    hitTest(t, e) {
      return (
        (ti.x = t),
        (ti.y = e),
        this.toModelPosition(ti, ti),
        this.internalModel.hitTest(ti.x, ti.y)
      );
    }
    ...
    init(t) {
      super.init(t),
        this.settings.expressions &&
          (this.expressionManager = new si(this.settings, t)),
  ...
  class ai extends Ie {
    ...
    init() {
      ...
      super.init(),
        (null == (t = this.settings.getEyeBlinkParameters())
          ? void 0
          : t.length) && (this.eyeBlink = u.create(this.settings)),
    ...
    update(t, e) {
      ...
      if (
        ...
        a.saveParameters(),
        null == (i = this.motionManager.expressionManager) || i.update(a, e),
        n || null == (s = this.eyeBlink) || s.updateParameters(a, t),
        this.updateFocus(),
        ...
        for (let i = 0; i < this.motionManager.lipSyncIds.length; ++i)
          a.addParameterValueById(this.motionManager.lipSyncIds[i], t, 0.8);
      }
      null == (r = this.physics) || r.evaluate(a, t),
        null == (o = this.pose) || o.updateParameters(a, t),
  ...
  class ni extends ye {
    constructor(t) {
      if ((super(t), o(this, "moc"), o(this, "textures"), !ni.isValidJSON(t)))
  ...
  function di(t) {
    (t = Object.assign(
      { logFunction: console.log, loggingLevel: w.LogLevel_Verbose },
      t
    )),
      S.startUp(t),
      S.initialize();
  ...
  Ye.registerRuntime({
    ...
    createInternalModel(t, e, i) {
      const s = new ai(t, e, i),
        r = t;
      return (
        r.__moc && ((s.__moc = r.__moc), delete r.__moc, s.once("destroy", ci)),
        s
      );
    },
    createPhysics: (t, e) => yt.create(e),
    ...
    (t.CSM_ASSERT = T),
    (t.Constant = b),
    (t.Cubism4ExpressionManager = si),
    (t.Cubism4InternalModel = ai),
    (t.Cubism4ModelSettings = ni),
    (t.Cubism4MotionManager = ri),
    (t.CubismBlendMode = C),
    (t.CubismBreath = n),
    (t.CubismClippingContext = zt),
    (t.CubismClippingManager_WebGL = Gt),
    (t.CubismDebug = A),
    (t.CubismExpressionMotion = G),
    (t.CubismEyeBlink = u),
    (t.CubismFramework = S),
    (t.CubismLogDebug = I),
    (t.CubismLogError = F),
    ...
    (t.CubismPose = c),
    (t.CubismRenderTextureResource = Xt),
    (t.CubismRenderer = x),
    (t.CubismRendererProfile_WebGL = jt),
    ...
    (t.ExpressionBlendType = z),
    (t.ExpressionManager = _e),
    (t.EyeState = d),
    (t.FileLoader = He),
    (t.FocusController = Ce),
    (t.HitAreaBody = "Body"),
    (t.HitAreaHead = "Head"),
    ...
    (t.Live2DLoader = De),
    (t.Live2DModel = ii),
    (t.Live2DTransform = Ke),
    (t.LogLevel = w),
    (t.ModelSettings = ye),
    (t.MotionManager = we),
    (t.MotionPreloadStrategy = Se),
    (t.MotionPriority = Me),
    (t.MotionState = ve),
    (t.Options = Mt),
    (t.ParamAngleX = ie),
    ...
    (t.copyArray = function (t, e, i, s, r) {
      const o = e[s];
      Array.isArray(o) &&
        (i[r] = o.filter((e) => null !== e && typeof e === t));
    }),
